...
chunk_size = 10000000 
chunks = pd.read_csv(tbl_file, sep='|', engine='python', header=None, names=names, dtype=lineitem_schema, usecols=range(len(names)), chunksize=chunk_size)
